...
export function Header() {
  return (
    <header className="relative h-[80px] w-full overflow-hidden bg-[#003f35] text-white">
      ...
      <div className="absolute bottom-[-1px] left-1/2 h-[24px] w-[120px] -translate-x-1/2 rounded-tl-[40px] bg-[#fbfaf6]" />
      ...
      <a href="/" aria-label="Kantineportalen forside" className="relative z-10 flex h-full items-center gap-4 pl-6">
        ...
        <span className="text-[22px] font-bold tracking-[-0.05em] text-white md:text-[24px]">Kantineportalen</span>
      </a>
    </header>
  )
}
